...
public class BlogService {
    ...
    public String postBlog(MultipartFile multipart, BlogPostRequestBody blogPostRequestBody) {
        return this.blogsRepository.addBlog(multipart, blogPostRequestBody);
    }
}
